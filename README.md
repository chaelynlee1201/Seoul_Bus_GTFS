...
**파일럿 확정:** 동대문구 통과 **96개 노선** 중, **2026-08 실측 승차량 상위 3개 노선(271·272·130)** 을
**240초(4분) 주기**로 04:00~00:30 관측 → 자정 전 3×300 = **900회/일** (도착정보 1,000 한도 내, 여유).
승차량 근거: `data/route_ridership_ranking.csv`. 전 96노선 관측은 ~수만 회/일 필요 → 트래픽 상향 시 확장.
(주기 240초는 첨두 배차간격 4~8분과 비슷·짧아 중간버스 누락(aliasing) 최소화.)
